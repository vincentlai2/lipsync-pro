...
export const metadata: Metadata = {
  ...
  description:
    'The page you are looking for could not be found. Explore our AI lip sync tools and resources.',
  robots: {
    index: false,
    follow: false,
    googleBot: {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="text-center">
            <CardHeader>
              ...
              <CardDescription>
                Our team is here to help you get the most out of AI lip sync
                technology
              </CardDescription>
            </CardHeader>
            <CardContent>
