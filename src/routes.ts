...
export enum Routes {
  ...
  Wav2LipPro = '/pricing',
  Wav2LipHowTo = '/how-to-create-lip-sync-videos',
  Wav2LipPrice = '/pricing',
  Wav2LipAlternative = '/ai-lip-sync-vs-traditional-dubbing',
  Wav2LipColab = '/video-translation-dubbing',
  Wav2LipWhatIs = '/what-is-ai-lip-sync',
  Blog = '/blog',
  Docs = '/docs',
  About = '/about',
  Contact = '/contact',
